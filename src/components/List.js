export default function List(props) {
    ...
    const totalgrammys = cartItems.reduce((a, c) => a + c.grammys, 0);
    ...
    return <aside className='block col-1'>
        ...
        <div>
            ...
            {cartItems.length !== 0 && (
                ...
                <hr/>
                <div className='row'>
                    <div className='col-2' id='name'>Total grammys</div>
                    <div className='col-1 text-right' id='name'>{totalgrammys} grammys</div>
                </div>
                <div className='row'>
